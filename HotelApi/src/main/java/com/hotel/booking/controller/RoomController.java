...
public class RoomController {
    ...
    public RoomController(IRoomService roomService, RoomRepository roomRepository) {
    ...
    @GetMapping("/all-available-rooms-by-date-and-type")
    ...
    public ResponseEntity<Response> updateRoom(
        ...
        Response response = roomService.updateRoomDetails(roomId,roomDescription,roomType,roomPrice,photo);
        return  ResponseEntity.status(response.getStatusCode()).body(response);
    }
